...
- Unfused-reference run `30737222429` produced exactly the same UVDoc metrics as `30736983229`; Paddle IR optimization is not the cause. `docs/uvdoc-parity-blocker.md` is the authoritative evidence and reassessment record. A product/architecture decision is required before changing the converter, model set, runtime strategy or acceptance rule.
